				...
				<form className="bg-white p-8 shadow-md rounded-lg" onSubmit={onFinish}>
					...
					<div className="mb-6">
						...
						<input type="text" id="Otp" value={otp}
							onChange={(event) => setOtp(event.target.value)} name="Otp" className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500" placeholder="Otp" required />
					</div>
